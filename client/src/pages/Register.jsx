...
export default function Register() {
  ...
  // Same as Login: return to the page that sent us here (e.g. a share link)
  // after creating the account, or the document list by default.
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gray-100 px-4">
      ...
      >
        <h1 className="mb-6 text-xl font-semibold text-gray-800">Create an account</h1>
        {error && (
